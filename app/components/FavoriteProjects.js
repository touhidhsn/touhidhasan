...
import favimg1 from '@/app/images/growthapp.jpg';
import favimg2 from '@/app/images/gamepreview.jpg';
import favimg3 from '@/app/images/jobpreview.jpg';
        ...
        <div className='grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40'>
          ...
          <div className='w-full block col-span-3 shadow-2xl'>
            <div className='relative overflow-hidden'>
              ...
              <h1 className='absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2'>
                UI design and developed in ReactJS
              </h1>
          ...
          <div className='w-full block col-span-3  sm:col-span-2 shadow-2xl'>
            <div className='relative overflow-hidden'>
              ...
              />
              <h1 className='absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2'>
                ReactJS - Data fetching, multiple filerting
              </h1>
              <h1 className='absolute bottom-10 left-10 text-gray-50 font-bold text-xl'>
                02
              </h1>
